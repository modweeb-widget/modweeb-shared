...
(function() {
  ...
  function applyDarkMode(isDark) {
    ...
    if (isDark) {
      ...
      if (toggle && toggle.querySelector('svg')) toggle.querySelector('svg').style.stroke = 'var(--white)';
    } else {
      ...
      if (toggle && toggle.querySelector('svg')) toggle.querySelector('svg').style.stroke = 'var(--bodyC)';
    }
  }
})();
